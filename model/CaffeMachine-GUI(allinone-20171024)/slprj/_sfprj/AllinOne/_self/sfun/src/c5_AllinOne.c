...
static void c5_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_k_emlrt_marshallIn(SFc5_AllinOneInstanceStruct
  *chartInstance, const mxArray *c5_b_setSimStateSideEffectsInfo, const char_T
  *c5_identifier);
static const mxArray *c5_l_emlrt_marshallIn(SFc5_AllinOneInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static const mxArray *sf_get_sim_state_info_c5_AllinOne(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[4],T\"CupRemain\",},{M[1],M[2],T\"JustaCup\",},{M[3],M[10],T\"CupAmount\",},{M[6],M[3],T\"FeedFinishEvent\",},{M[7],M[3],T\"FeedFinishEventEventCounter\",},{M[8],M[0],T\"is_active_c5_AllinOne\",},{M[9],M[0],T\"is_c5_AllinOne\",},{M[11],M[21],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M[8],M[1]}}}}"
  };
...
extern const mxArray* sf_internal_get_sim_state_c5_AllinOne(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_AllinOne((SFc5_AllinOneInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_AllinOne();/* state var info */
...
extern void sf_internal_set_sim_state_c5_AllinOne(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_AllinOne();/* state var info */
...
{
  return sf_internal_get_sim_state_c5_AllinOne(S);
}

static void sf_opaque_set_sim_state_c5_AllinOne(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_AllinOne(S, st);
}
