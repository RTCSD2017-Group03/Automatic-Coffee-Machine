...
static void c7_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_k_emlrt_marshallIn(SFc7_AllinOneInstanceStruct
  *chartInstance, const mxArray *c7_b_setSimStateSideEffectsInfo, const char_T
  *c7_identifier);
static const mxArray *c7_l_emlrt_marshallIn(SFc7_AllinOneInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
...
extern const mxArray* sf_internal_get_sim_state_c7_AllinOne(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_AllinOne((SFc7_AllinOneInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_AllinOne();/* state var info */
...
extern void sf_internal_set_sim_state_c7_AllinOne(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c7_AllinOne();/* state var info */
...
{
  return sf_internal_get_sim_state_c7_AllinOne(S);
}

static void sf_opaque_set_sim_state_c7_AllinOne(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_AllinOne(S, st);
}
