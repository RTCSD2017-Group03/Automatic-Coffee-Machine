...
static real_T c12_g_emlrt_marshallIn(SFc12_AllinOneInstanceStruct *chartInstance,
  const mxArray *c12_CoffeeAmount, const char_T *c12_identifier);
    ...
    switch (chartInstance->c12_is_c12_AllinOne) {
     ...
     case c12_IN_prepare_AmerricanCoffee:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 29U,
                   chartInstance->c12_sfEvent);
      c12_d_out = (CV_TRANSITION_EVAL(29U, (int32_T)_SFD_CCP_CALL(29U, 0,
     ...
     case c12_IN_prepare_Cappuccino:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 28U,
                   chartInstance->c12_sfEvent);
      c12_e_out = (CV_TRANSITION_EVAL(28U, (int32_T)_SFD_CCP_CALL(28U, 0,
        c12_checkall(chartInstance, *c12_WaterRemain,
                     chartInstance->c12_WaterRecipe, *c12_MilkRemain,
                     chartInstance->c12_MilkRecipe, *c12_SugarRemain,
                     chartInstance->c12_SugarRecipe, *c12_CoffeeRemain,
     ...
     case c12_IN_prepare_CoffeeLatte:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 5U,
                   chartInstance->c12_sfEvent);
      c12_f_out = (CV_TRANSITION_EVAL(5U, (int32_T)_SFD_CCP_CALL(5U, 0,
        c12_checkall(chartInstance, *c12_WaterRemain,
                     chartInstance->c12_WaterRecipe, *c12_MilkRemain,
                     chartInstance->c12_MilkRecipe, *c12_SugarRemain,
                     chartInstance->c12_SugarRecipe, *c12_CoffeeRemain,
...
static void c12_Init(SFc12_AllinOneInstanceStruct *chartInstance)
{
  ...
  if (c12_out) {
    ...
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, chartInstance->c12_sfEvent);
    chartInstance->c12_tp_prepare_CoffeeLatte = 1U;
    chartInstance->c12_CoffeeRecipe = 25.0;
    _SFD_DATA_RANGE_CHECK(chartInstance->c12_CoffeeRecipe, 11U);
    chartInstance->c12_MilkRecipe = 15.0;
    _SFD_DATA_RANGE_CHECK(chartInstance->c12_MilkRecipe, 12U);
    chartInstance->c12_SugarRecipe = 10.0;
    _SFD_DATA_RANGE_CHECK(chartInstance->c12_SugarRecipe, 13U);
    chartInstance->c12_WaterRecipe = 50.0;
    _SFD_DATA_RANGE_CHECK(chartInstance->c12_WaterRecipe, 14U);
  } else {
    ...
    if (c12_b_out) {
      ...
      chartInstance->c12_CoffeeRecipe = 25.0;
      _SFD_DATA_RANGE_CHECK(chartInstance->c12_CoffeeRecipe, 11U);
      chartInstance->c12_MilkRecipe = 20.0;
      _SFD_DATA_RANGE_CHECK(chartInstance->c12_MilkRecipe, 12U);
      chartInstance->c12_SugarRecipe = 5.0;
      _SFD_DATA_RANGE_CHECK(chartInstance->c12_SugarRecipe, 13U);
      chartInstance->c12_WaterRecipe = 50.0;
      _SFD_DATA_RANGE_CHECK(chartInstance->c12_WaterRecipe, 14U);
    } else {
      ...
      if (c12_c_out) {
        ...
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c12_sfEvent);
        chartInstance->c12_tp_prepare_AmerricanCoffee = 1U;
        chartInstance->c12_CoffeeRecipe = 35.0;
        _SFD_DATA_RANGE_CHECK(chartInstance->c12_CoffeeRecipe, 11U);
        chartInstance->c12_MilkRecipe = 10.0;
        _SFD_DATA_RANGE_CHECK(chartInstance->c12_MilkRecipe, 12U);
        chartInstance->c12_SugarRecipe = 5.0;
        _SFD_DATA_RANGE_CHECK(chartInstance->c12_SugarRecipe, 13U);
        chartInstance->c12_WaterRecipe = 50.0;
       ...
       case c12_IN_Working:
        ...
        if (c12_b_temp) {
          c12_b_temp = (_SFD_CCP_CALL(37U, 1,
            ...
            (chartInstance->c12_WaterRecipe * 100.0), 32U, 37U) != 0U,
            chartInstance->c12_sfEvent) != 0);
        }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2923469749U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2860888336U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3638386887U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(746238890U);
}
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        {
          static unsigned int sStartGuardMap[] = { 23, 0 };

          static unsigned int sEndGuardMap[] = { 27, 28 };
...
extern const mxArray* sf_internal_get_sim_state_c12_AllinOne(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_AllinOne((SFc12_AllinOneInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_AllinOne();/* state var info */
...
extern void sf_internal_set_sim_state_c12_AllinOne(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c12_AllinOne();/* state var info */
...
{
  return sf_internal_get_sim_state_c12_AllinOne(S);
}

static void sf_opaque_set_sim_state_c12_AllinOne(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c12_AllinOne(S, st);
}
...
static void mdlSetWorkWidths_c12_AllinOne(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(325975636U));
  ssSetChecksum1(S,(201005886U));
  ssSetChecksum2(S,(4126012088U));
  ssSetChecksum3(S,(3944629513U));
