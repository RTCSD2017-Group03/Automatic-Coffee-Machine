...
static void c3_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_k_emlrt_marshallIn(SFc3_AllinOneInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_l_emlrt_marshallIn(SFc3_AllinOneInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_AllinOneInstanceStruct
  *chartInstance, uint32_T c3_vectorIndex);
static void c3_errorIfDataNotWrittenToFcn(SFc3_AllinOneInstanceStruct
  ...
  const mxArray *c3_st)
{
  ...
  *c3_ClearIntegratorEvent = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_AllinOne = c3_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 4)), "is_active_c3_AllinOne");
  chartInstance->c3_is_c3_AllinOne = c3_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 5)), "is_c3_AllinOne");
...
static const mxArray *sf_get_sim_state_info_c3_AllinOne(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[3],T\"RemainLiquid\",},{M[3],M[11],T\"TargetAmount\",},{M[6],M[4],T\"ClearIntegratorEvent\",},{M[7],M[4],T\"ClearIntegratorEventEventCounter\",},{M[8],M[0],T\"is_active_c3_AllinOne\",},{M[9],M[0],T\"is_c3_AllinOne\",},{M[11],M[17],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M[15],M[1]}}}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_AllinOneInstanceStruct *) chartInfo->chartInstance;
...
extern const mxArray* sf_internal_get_sim_state_c3_AllinOne(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_AllinOne((SFc3_AllinOneInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_AllinOne();/* state var info */
...
extern void sf_internal_set_sim_state_c3_AllinOne(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_AllinOne();/* state var info */
...
{
  return sf_internal_get_sim_state_c3_AllinOne(S);
}

static void sf_opaque_set_sim_state_c3_AllinOne(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_AllinOne(S, st);
}
