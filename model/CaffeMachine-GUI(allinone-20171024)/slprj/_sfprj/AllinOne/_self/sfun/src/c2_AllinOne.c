...
static void c2_durationReferenceTimeUpdater(SFc2_AllinOneInstanceStruct
  *chartInstance);
...
static const mxArray *c2_n_emlrt_marshallIn(SFc2_AllinOneInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc2_AllinOneInstanceStruct
  *chartInstance, int32_T c2_ssid);
static void c2_init_sf_message_store_memory(SFc2_AllinOneInstanceStruct
  *chartInstance);
...
static void initialize_c2_AllinOne(SFc2_AllinOneInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_AllinOne(chartInstance);
  ...
  *chartInstance)
{
  ...
  c2_i_y = NULL;
  sf_mex_assign(&c2_i_y, sf_mex_create("y",
  ...
  const mxArray *c2_st)
{
  ...
  *chartInstance->c2_RemainLiquid = c2_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("RemainLiquid", c2_u, 0)), "RemainLiquid");
  chartInstance->c2_TargetAmount = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("TargetAmount", c2_u, 1)), "TargetAmount");
  *chartInstance->c2_ClearIntegratorEvent = c2_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("ClearIntegratorEvent", c2_u, 2)),
  ...
  chartInstance->c2_ClearIntegratorEventEventCounter = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("ClearIntegratorEventEventCounter",
       c2_u, 3)), "ClearIntegratorEventEventCounter");
  chartInstance->c2_is_active_c2_AllinOne = c2_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c2_AllinOne", c2_u, 4)),
    "is_active_c2_AllinOne");
  chartInstance->c2_is_c2_AllinOne = c2_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c2_AllinOne", c2_u, 5)), "is_c2_AllinOne");
  chartInstance->c2_temporalCounter_i1 = c2_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("temporalCounter_i1", c2_u, 6)),
    "temporalCounter_i1");
  c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "dataWrittenToVector", c2_u, 7)), "dataWrittenToVector", c2_bv0);
  ...
  sf_mex_assign(&chartInstance->c2_setSimStateSideEffectsInfo,
    ...
    "setSimStateSideEffectsInfo", c2_u, 8)), "setSimStateSideEffectsInfo"), true);
  sf_mex_destroy(&c2_u);
  ...
  (SFc2_AllinOneInstanceStruct *chartInstance)
{
  if (chartInstance->c2_doSetSimStateSideEffects != 0) {
    ...
    chartInstance->c2_tp_Ready = (uint8_T)(chartInstance->c2_is_c2_AllinOne ==
      c2_IN_Ready);
    chartInstance->c2_tp_Transmiting = (uint8_T)
...
static void sf_gateway_c2_AllinOne(SFc2_AllinOneInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  c2_durationReferenceTimeUpdater(chartInstance);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_OutLiquid, 2U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_SettingAmount, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  ...
  switch (chartInstance->c2_is_c2_AllinOne) {
   ...
   case c2_IN_Ready:
    ...
    if (c2_b_out) {
      ...
      _SFD_DATA_RANGE_CHECK(chartInstance->c2_TargetAmount, 0U, 4U, 2U,
                            chartInstance->c2_sfEvent, false);
      if (!chartInstance->c2_dataWrittenToVector[1U]) {
        _SFD_DATA_READ_BEFORE_WRITE_ERROR(0U, 4U, 2U, chartInstance->c2_sfEvent,
          false);
      }
      ...
      c2_x = c2_A;
      c2_b_x = c2_x;
      *chartInstance->c2_RemainLiquid = c2_b_x / 3.0;
      chartInstance->c2_dataWrittenToVector[0U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c2_RemainLiquid, 3U, 4U, 2U,
                            chartInstance->c2_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
   ...
   case c2_IN_Transmiting:
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_out, 2U, c2_b_sf_marshallOut,
      c2_b_sf_marshallIn);
    if (!chartInstance->c2_dataWrittenToVector[1U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(0U, 5U, 1U, chartInstance->c2_sfEvent,
        false);
    }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(293026268U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3001939365U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1886787624U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1575279261U);
}
...
mxArray *sf_c2_AllinOne_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("G6UTELF8wXKjkaLqlsdLZ");
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc2_AllinOneInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_AllinOneInstanceStruct *chartInstance = (SFc2_AllinOneInstanceStruct *)
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_SettingAmount);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c2_RemainLiquid);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_OutLiquid);
        _SFD_SET_DATA_VALUE_PTR(0U, &chartInstance->c2_TargetAmount);
      }
    }
  }
}
...
static void mdlSetWorkWidths_c2_AllinOne(SimStruct *S)
{
  ...
  if (sim_mode_is_modelref_sim(S)) {
    ...
    ssSetChecksum0(S,(227354710U));
    ssSetChecksum1(S,(1106679418U));
    ssSetChecksum2(S,(781959663U));
    ssSetChecksum3(S,(2226123390U));
  }
...
static void mdlStart_c2_AllinOne(SimStruct *S)
{
  ...
  mdl_start_c2_AllinOne(chartInstance);
}
  ...
  *testPointMappingInfo)
{
  ...
  chartDatasetLoggingObjs = get_dataset_logging_obj_vector
    ((SFc2_AllinOneInstanceStruct *)sf_get_chart_instance_ptr(S));
