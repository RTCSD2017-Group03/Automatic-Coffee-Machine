...
#include <stddef.h>
#include "blas.h"
#include "Control_sfun.h"
#include "c12_Control.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Control_sfun_debug_macros.h"
...
static void initialize_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void initialize_params_c12_Control(SFc12_ControlInstanceStruct
  *chartInstance);
static void enable_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void disable_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_Control(SFc12_ControlInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c12_Control(SFc12_ControlInstanceStruct
  *chartInstance);
static void set_sim_state_c12_Control(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_st);
static void c12_set_sim_state_side_effects_c12_Control
  (SFc12_ControlInstanceStruct *chartInstance);
static void finalize_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void sf_gateway_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void mdl_start_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void c12_chartstep_c12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void initSimStructsc12_Control(SFc12_ControlInstanceStruct *chartInstance);
static void c12_Init(SFc12_ControlInstanceStruct *chartInstance);
static void c12_GetCup(SFc12_ControlInstanceStruct *chartInstance);
static void c12_working_Coffee(SFc12_ControlInstanceStruct *chartInstance);
static void c12_exit_internal_working_Coffee(SFc12_ControlInstanceStruct
  *chartInstance);
static void c12_Step1(SFc12_ControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static boolean_T c12_checkall(SFc12_ControlInstanceStruct *chartInstance, real_T
  c12_waterRemain, real_T c12_waterRecipe, real_T c12_milkRemain, real_T
...
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int8_T c12_emlrt_marshallIn(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static uint32_T c12_b_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_b_GetCupEventEventCounter, const char_T
  *c12_identifier);
static uint32_T c12_c_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_b_tp_Init, const char_T *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_g_emlrt_marshallIn(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_b_CoffeeAmount, const char_T *c12_identifier);
static real_T c12_h_emlrt_marshallIn(SFc12_ControlInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static boolean_T c12_i_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_flg, const char_T *c12_identifier);
static boolean_T c12_j_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint16_T c12_k_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_b_temporalCounter_i2, const char_T
  *c12_identifier);
static uint16_T c12_l_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static const mxArray *c12_m_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_b_setSimStateSideEffectsInfo, const char_T *
  c12_identifier);
static const mxArray *c12_n_emlrt_marshallIn(SFc12_ControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_ControlInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc12_ControlInstanceStruct *chartInstance);
...
static void initialize_c12_Control(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_temporalCounter_i1 = 0U;
  chartInstance->c12_is_active_c12_Control = 0U;
  chartInstance->c12_is_c12_Control = c12_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c12_is_c12_Control == c12_IN_Step1) {
  ...
  *chartInstance)
{
  ...
  c12_l_hoistedGlobal = chartInstance->c12_is_active_c12_Control;
  ...
  c12_q_hoistedGlobal = chartInstance->c12_is_c12_Control;
  ...
  const mxArray *c12_st)
{
  ...
  *chartInstance->c12_GetCupEvent = c12_i_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c12_is_active_c12_Control = c12_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 11)),
     "is_active_c12_Control");
  ...
  chartInstance->c12_is_c12_Control = c12_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c12_u, 16)), "is_c12_Control");
  ...
  c12_update_debugger_state_c12_Control(chartInstance);
...
static void sf_gateway_c12_Control(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  c12_set_sim_state_side_effects_c12_Control(chartInstance);
  ...
  if (*chartInstance->c12_Tick == 1) {
    ...
    c12_chartstep_c12_Control(chartInstance);
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_ControlMachineNumber_,
...
static void c12_chartstep_c12_Control(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c12_is_active_c12_Control == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c12_sfEvent);
    chartInstance->c12_is_active_c12_Control = 1U;
    ...
    chartInstance->c12_is_c12_Control = c12_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c12_sfEvent);
    chartInstance->c12_tp_Init = 1U;
    *chartInstance->c12_CoffeeAmount = 0.0;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c12_CoffeeAmount, 3U);
    ...
    *chartInstance->c12_NextStep = 0.0;
    ...
    switch (chartInstance->c12_is_c12_Control) {
     case c12_IN_GetCup:
      CV_CHART_EVAL(0, 0, 1);
     ...
     case c12_IN_Step2:
      ...
      if (c12_out) {
        ...
        *chartInstance->c12_NextStep = 0.0;
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c12_sfEvent);
        chartInstance->c12_is_c12_Control = c12_IN_TakeOut;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c12_sfEvent);
        chartInstance->c12_tp_TakeOut = 1U;
      } else {
        ...
        if (c12_b_out) {
          ...
          *chartInstance->c12_NextStep = 0.0;
          ...
          _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 3U, chartInstance->c12_sfEvent);
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c12_sfEvent);
          chartInstance->c12_is_c12_Control = c12_IN_error;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, chartInstance->c12_sfEvent);
          chartInstance->c12_tp_error = 1U;
        } else {
     ...
     case c12_IN_prepare_CoffeeLatte:
      ...
      if (c12_d_out) {
        ...
        chartInstance->c12_tp_prepare_CoffeeLatte = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, chartInstance->c12_sfEvent);
        chartInstance->c12_is_c12_Control = c12_IN_GetCup;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c12_sfEvent);
        chartInstance->c12_temporalCounter_i1 = 0U;
        chartInstance->c12_tp_GetCup = 1U;
        chartInstance->c12_GetCupEventEventCounter++;
...
static void c12_Init(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  if (c12_out) {
    ...
    chartInstance->c12_tp_Init = 0U;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c12_sfEvent);
    chartInstance->c12_is_c12_Control = c12_IN_prepare_CoffeeLatte;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c12_sfEvent);
    chartInstance->c12_tp_prepare_CoffeeLatte = 1U;
    ...
    if (c12_b_out) {
      ...
      chartInstance->c12_tp_Init = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c12_sfEvent);
      chartInstance->c12_is_c12_Control = c12_IN_working_Cappuccino;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, chartInstance->c12_sfEvent);
      chartInstance->c12_tp_working_Cappuccino = 1U;
      chartInstance->c12_CoffeeRecipe = 10.0;
      _SFD_DATA_RANGE_CHECK(chartInstance->c12_CoffeeRecipe, 11U);
      ...
      if (c12_c_out) {
        ...
        chartInstance->c12_tp_Init = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c12_sfEvent);
        chartInstance->c12_is_c12_Control = c12_IN_working_AmerricanCoffee;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, chartInstance->c12_sfEvent);
        chartInstance->c12_tp_working_AmerricanCoffee = 1U;
        chartInstance->c12_CoffeeRecipe = 10.0;
        _SFD_DATA_RANGE_CHECK(chartInstance->c12_CoffeeRecipe, 11U);
...
static void c12_GetCup(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  if (c12_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c12_sfEvent);
    chartInstance->c12_is_c12_Control = c12_IN_Step1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c12_sfEvent);
    chartInstance->c12_temporalCounter_i1 = 0U;
    chartInstance->c12_tp_Step1 = 1U;
...
static void c12_working_Coffee(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  if (c12_out) {
    ...
    chartInstance->c12_tp_working_Coffee = 0U;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, chartInstance->c12_sfEvent);
    chartInstance->c12_is_c12_Control = c12_IN_Step2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c12_sfEvent);
    chartInstance->c12_temporalCounter_i1 = 0U;
    chartInstance->c12_tp_Step2 = 1U;
    *chartInstance->c12_NextStep = 50.0;
...
static void c12_Step1(SFc12_ControlInstanceStruct *chartInstance)
{
  ...
  if (c12_out) {
    ...
    *chartInstance->c12_NextStep = 0.0;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c12_sfEvent);
    chartInstance->c12_is_c12_Control = c12_IN_working_Coffee;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, chartInstance->c12_sfEvent);
    chartInstance->c12_temporalCounter_i2 = 0U;
    chartInstance->c12_tp_working_Coffee = 1U;
...
const mxArray *sf_c12_Control_get_eml_resolved_functions_info(void)
{
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_ControlInstanceStruct *chartInstance;
  chartInstance = (SFc12_ControlInstanceStruct *)chartInstanceVoid;
...
void sf_c12_Control_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_Control_get_post_codegen_info(void);
mxArray *sf_c12_Control_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_Control_get_post_codegen_info();
...
mxArray *sf_c12_Control_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_Control_jit_fallback_info(void)
{
...
mxArray *sf_c12_Control_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_Control(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[7],M[13],T\"GetCupEventEventCounter\",},{M[8],M[0],T\"is_active_c12_Control\",},{M[8],M[649],T\"is_active_CoffeeDoserState\",},{M[8],M[657],T\"is_active_SugarDoserState\",},{M[8],M[661],T\"is_active_WaterState\",},{M[8],M[666],T\"is_active_MilkDoserState\",},{M[9],M[0],T\"is_c12_Control\",},{M[9],M[649],T\"is_CoffeeDoserState\",},{M[9],M[657],T\"is_SugarDoserState\",},{M[9],M[661],T\"is_WaterState\",}}",
  ...
  sf_c12_Control_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_ControlInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_ControlMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_ControlMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _ControlMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c12_Control(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_ControlInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
  initialize_c12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_Control(void *chartInstanceVar)
{
  enable_c12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_Control(void *chartInstanceVar)
{
  disable_c12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_Control(void *chartInstanceVar)
{
  sf_gateway_c12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_Control(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c12_Control((SFc12_ControlInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_Control(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c12_Control((SFc12_ControlInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c12_Control(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_ControlInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Control_optimization_info();
    }

    finalize_c12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_Control((SFc12_ControlInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_Control(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c12_Control((SFc12_ControlInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Control_optimization_info();
...
static void mdlRTW_c12_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_Control(SimStruct *S)
{
  SFc12_ControlInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_ControlInstanceStruct *)utMalloc(sizeof
    (SFc12_ControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_ControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_Control;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c12_Control;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_Control;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_Control;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_Control;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_Control;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_Control;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c12_Control;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_Control;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_Control;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_Control;
...
void c12_Control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_Control(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_Control(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_Control(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_Control_method_dispatcher.\n"
