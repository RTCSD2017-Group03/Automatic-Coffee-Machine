...
## Generated on : Sun Nov 05 01:15:27 2017
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ControlSystem.exe
...
MAKEFILE                  = ControlSystem.mk
COMPUTER                  = PCWIN64
MATLAB_ROOT               = F:\MATLAB\R2015b
MATLAB_BIN                = F:\MATLAB\R2015b\bin
MATLAB_ARCH_BIN           = F:\MATLAB\R2015b\bin\win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\zhiping\Desktop\CaffeMachine-GUI(allinone-20171024)
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE     = ControlSystem_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ControlSystem.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\ControlSystem_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\ControlSystem_ert_rtw\ControlSystem.c

MAIN_SRC = $(START_DIR)\ControlSystem_ert_rtw\ert_main.c
...
{$(START_DIR)\ControlSystem_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ControlSystem_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
