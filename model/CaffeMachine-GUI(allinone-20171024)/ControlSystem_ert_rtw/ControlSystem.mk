...
## Generated on : Mon Nov 06 12:11:53 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ControlSystem.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/dell1/Desktop/coffee_machine/model/CaffeMachine-GUI(allinone-20171024)
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ControlSystem.elf
...
SRCS = $(START_DIR)/ControlSystem_ert_rtw/ControlSystem.c $(START_DIR)/ControlSystem_ert_rtw/ControlSystem_data.c
...
OBJS = ControlSystem.o ControlSystem_data.o
...
%.o : $(START_DIR)/ControlSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/ControlSystem_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/ControlSystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/ControlSystem_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/ControlSystem_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
